...
/**
 * Gap/CFS Feature Page: No approval workflow.
 * Slug: no-approval-workflow
 * Backend: /api/gap-no-approval-workflow
 */
export default function NoApprovalWorkflowPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-approval-workflow', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No approval workflow.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No approval workflow.</p>
