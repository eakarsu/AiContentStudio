...
/**
 * Gap/CFS Feature Page: No cross-platform published-content analytics aggregation.
 * Slug: no-cross-platform-published-content-analytics-aggregation
 * Backend: /api/gap-no-cross-platform-published-content-analytics-aggregation
 */
export default function NoCrossPlatformPublishedContentAnalyticsAggregationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-cross-platform-published-content-analytics-aggregation', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No cross-platform published-content analytics aggregation.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No cross-platform published-content analytics aggregation.</p>
