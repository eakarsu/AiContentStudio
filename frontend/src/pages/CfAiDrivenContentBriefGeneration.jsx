...
/**
 * Gap/CFS Feature Page: AI-driven content brief generation
 * Slug: ai-driven-content-brief-generation
 * Backend: /api/cf-ai-driven-content-brief-generation
 */
export default function AiDrivenContentBriefGenerationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-ai-driven-content-brief-generation', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>AI-driven content brief generation</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Chat-based UX; user describes goal/audience; AI generates full brief (SEO targets, tone, length, key points, call-to-action).</p>
