...
/**
 * Gap/CFS Feature Page: Automated A/B testing
 * Slug: automated-a-b-testing
 * Backend: /api/cf-automated-a-b-testing
 */
export default function AutomatedABTestingPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-automated-a-b-testing', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Automated A/B testing</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Generate content variants with different angles; automatically publish to test audiences; report winner.</p>
