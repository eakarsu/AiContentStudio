...
/**
 * Gap/CFS Feature Page: Influencer outreach automation
 * Slug: influencer-outreach-automation
 * Backend: /api/cf-influencer-outreach-automation
 */
export default function InfluencerOutreachAutomationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-influencer-outreach-automation', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Influencer outreach automation</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Identify relevant influencers for content; draft personalized pitch emails.</p>
