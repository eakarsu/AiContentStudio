...
/**
 * Gap/CFS Feature Page: No team collaboration or granular permission management.
 * Slug: no-team-collaboration-or-granular-permission-management
 * Backend: /api/gap-no-team-collaboration-or-granular-permission-management
 */
export default function NoTeamCollaborationOrGranularPermissionManagementPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-team-collaboration-or-granular-permission-management', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No team collaboration or granular permission management.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No team collaboration or granular permission management.</p>
